...
const HighIndicator = ({ currentPrice, high, low }) => {
...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    <div className='fixed top-0 w-full h-full bg-gray-200 bg-opacity-30               
    backdrop-blur-sm flex items-center justify-center font-nunito'

      onClick={close}
    >

      <div className='w-[65%] h-[90%] bg-gray-300 bg-opacity-75 rounded-lg text-white relative'
      ...
      >
        {data ?
          ...
          <div className='flex items-center justify-between h-full w-full p-4'>
            <div
              className='flex flex-col w-[45%] h-full pr-2 '>
              <div className='flex w-full items-center'>
                ...
                <span className='text-sm py-0.5 px-2.5 ml-2 bg-cyan 
              text-cyan bg-opacity-25 rounded uppercase'>{data.symbol}</span>
              </div>
              ...
              <div className='flex w-full mt-6'>
                <div className='flex flex-col w-full'>
                  <div className='flex justify-between'>
                    ...
                    <div
                      className={`text-sm px-1 ml-2 font-md flex items-center rounded 
              ...
              <div className='flex w-full mt-4 justify-between'>
                ...
                <div className='flex flex-col content-start'>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <div
                      className={`text-sm px-1 ml-2 my-1 font-md flex items-center rounded 
            ...
            <div className='absolute bottom-8 right-8 flex items-center'>
              ...
              {data.links.repos_url.github[0] &&
                ...
                target={"_blank"} rel='noreferre' href={data.links.repos_url.github[0]}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                    height="1em"
              ...
              {data.links.twitter_screen_name &&
                <a 
                className='text-lg px-1'
                target={"_blank"} rel='noreferre' href={`https://twitter.com/${data.links.twitter_screen_name}`}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                    height="1em"
              ...
              {data.links.subreddit_url &&
                <a 
                className='text-lg px-1'
                target={"_blank"} rel='noreferre' href={data.links.subreddit_url}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                    height="1em"
              ...
              {data.links.facebook_username &&
                <a 
                className='text-lg px-1'
                target={"_blank"} rel='noreferre' href={`https://facebook.com/${data.links.facebook_username}`}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                    height="1em"
