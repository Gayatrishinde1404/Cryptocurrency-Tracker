...
const Pagination = () => {
  ...
  let {page, setPage, cryptoData} = useContext(CryptoContext);
      ...
      <div className='flex items-center'>
        ...
        <ul className='flex items-center justify-end text-sm'>
          ...
          </li>
          {
            ...
            className='outline-0 hover:text-cyan rounded-full w-8 h-8 flex items-center justify-center text-lg'>...</button> 
            </li> 
              ) : null
          }
          {
  ...
  
          {
            page !== TotalNumber ? (<li>
              <button onClick={() => setPage(TotalNumber)}
                className='outline-0 hover:text-cyan rounded-full w-8 h-8 flex items-center justify-center bg-gray-200 mx-1.5'>{TotalNumber}</button></li>
            ) : null}
          <li>
